...
<body>
  <div class="container text-center" id="body">
    ...
    <form method="post">
      <input type="submit" name="memoria" class="btn btn-outline-success" value="M">
      <input type="submit" name="limpar" class="btn btn-outline-success" value="Limpar Memória">
      <input type="submit" name="recuperar" class="btn btn-outline-success" value="Recuperar Memória">
    </form>
